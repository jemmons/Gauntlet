...
/**
 Holds constants of notification names. A client may want to define `GAUNTLET_POST_TEST_NOTIFICATIONS` and  observe notificationas with these names when testing.
